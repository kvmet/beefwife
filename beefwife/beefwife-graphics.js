...
const BeefwifeGraphics = (() => {
  ...
  const Display =
    typeof BeefwifeDisplay !== "undefined"
      ? BeefwifeDisplay
      : typeof module !== "undefined" && module.exports
        ? require("./beefwife-display.js")
        : null;
  if (!Display)
    throw new Error("Beefwife graphics requires beefwife-display.js");
  const { discard, resizeGraphics, contextFor, meshFor, setShapeTransform } =
    Display;
